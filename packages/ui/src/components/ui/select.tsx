...
const Select: React.FC<SelectProps> = SelectPrimitive.Root;

type SelectGroupProps = React.ComponentPropsWithoutRef<typeof SelectPrimitive.Group>;
const SelectGroup: React.FC<SelectGroupProps> = SelectPrimitive.Group;

type SelectValueProps = React.ComponentPropsWithoutRef<typeof SelectPrimitive.Value>;
const SelectValue: React.FC<SelectValueProps> = SelectPrimitive.Value;
