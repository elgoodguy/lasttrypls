      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <div className="grid gap-4 px-6 py-4">
          <Button variant="outline" onClick={() => handleOAuthLogin('google')} disabled={isLoading}>
             <svg className="mr-2 h-4 w-4" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="google" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512"><path fill="currentColor" d="M488 261.8C488 403.3 391.1 504 248 504 110.8 504 0 393.2 0 256S110.8 8 248 8c66.8 0 126 23.4 172.9 61.9l-76.7 60.5c-19.7-17.8-47.4-28.8-78.2-28.8-66.8 0-120.9 54.2-120.9 120.9s54.1 120.9 120.9 120.9c76.3 0 104.2-52.4 109.3-78.5H248v-68.6h239.8c4.7 25.5 7.2 52.9 7.2 81.8z"></path></svg>
             Google
          </Button>
        ...
        <DialogFooter className="px-6 pb-4">
          <p className="text-sm text-muted-foreground">
            ...
            <Button variant="link" className="p-0 h-auto" onClick={() => { setIsSigningUp(!isSigningUp); setError(null); setMessage(null); }}>
